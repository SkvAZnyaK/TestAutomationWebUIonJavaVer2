package ru.gb.lessons.Lesson7and8;
...
import ru.gb.lessons.Lesson7and8.MyExtention.ConfigUiExtention;
import ru.gb.lessons.Lesson7and8.Pages.BasicElementsPage;
import ru.gb.lessons.Lesson7and8.Pages.UiAuthorizationPage;

import static com.codeborne.selenide.Selenide.open;
import static com.codeborne.selenide.Selenide.page;
import static ru.gb.lessons.Lesson7and8.Pages.Blocks.HeaderBlockEnums.HeaderFirstLevelMenu.WOMEN;
import static ru.gb.lessons.Lesson7and8.Pages.Blocks.HeaderBlockEnums.HeaderSecondLevelMenu.CASUALDRESSES;
import static ru.gb.lessons.Lesson7and8.Pages.Blocks.HeaderBlockEnums.HeaderSecondLevelMenu.SUMMERDRESSES;

@ExtendWith(ConfigUiExtention.class)
@DisplayName("Тестирование интернет-магазина женской одежды")
public class Hw78AllureSelenideTest {
